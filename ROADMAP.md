...
- [x] **Password locker design**: a built-in locker that cannot be bulk-stolen: its data key is
      ...
      off, so this item stays unticked until Daniel signs off. Signed off by Daniel on 2026-09-25. (#104)
